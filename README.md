...
$ DOCKER_BUILDKIT=1 docker build -f irods_core_builder.ubuntu16.Dockerfile -t irods-core-builder-ubuntu16 .
...
$ DOCKER_BUILDKIT=1 docker build -f irods_runner.ubuntu16.Dockerfile -t irods-runner-ubuntu16 .
...
```bash
DOCKER_BUILDKIT=1 docker build -f plugin_builder.ubuntu16.Dockerfile -t irods-plugin-builder:ubuntu-16.04 .
