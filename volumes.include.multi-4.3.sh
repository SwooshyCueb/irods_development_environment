...
repo_names=(
    ...
    ["auth_pam_interactive"]="irods_auth_plugin_pam_interactive"
    ...
    ["client_globus"]="irods_client_globus_connector"
    ["client_http_api"]="irods_client_http_api"
    ["client_s3_cpp"]="irods_client_s3_cpp"
    ["msi_curl"]="irods_microservice_plugins_curl"
    ["suite_netcdf"]="irods_netcdf"
    ["fw_policy_comp"]="irods_policy_composition_framework"
    ...
    ["re_policy"]="irods_rule_engine_plugins_policy"
)
...
volumes_ro=(
    ["/externals"]="${DEVROOT}/externals-${OS_NAME}-builds"
)
...
# Comment this out when not using custom externals
#BUILD_OPTIONS+=" --custom-externals /externals"
